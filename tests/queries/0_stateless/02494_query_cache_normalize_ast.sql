...
SELECT '---';
SELECT 1 SETTINGS use_query_cache = true, use_query_cache_active_usage = false, max_threads = 16;
...
WHERE type = 'QueryFinish'
  AND query = 'SELECT 1 SETTINGS use_query_cache = true, use_query_cache_active_usage = false, max_threads = 16;';
