...
SELECT 1 SETTINGS use_query_cache = true, use_query_cache_active_usage = false;
SELECT COUNT(*) FROM system.query_cache;
...
WHERE type = 'QueryFinish'
  AND query = 'SELECT 1 SETTINGS use_query_cache = true, use_query_cache_active_usage = false;';
