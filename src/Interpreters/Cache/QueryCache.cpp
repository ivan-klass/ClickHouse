...
public:
    ...
    /// E.g. SELECT 1 SETTINGS enable_experimental_query_cache = true
    /// and  SELECT 1;
...
/// Consider
///   (1) SET enable_experimental_query_cache = true;
///       SELECT expensiveComputation(...) SETTINGS max_threads = 64, query_cache_ttl = 300;
///       SET enable_experimental_query_cache = false;
/// and
///   (2) SELECT expensiveComputation(...) SETTINGS max_threads = 64, enable_experimental_query_cache_passive_usage = true;
