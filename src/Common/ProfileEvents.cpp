...
#define APPLY_FOR_EVENTS(M) \
    ...
    M(QueryCacheHits, "Number of times a query result has been found in the query result cache (and query computation was avoided).") \
    M(QueryCacheMisses, "Number of times a query result has not been found in the query result cache (and required query computation).") \
